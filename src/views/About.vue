...
export default {
  ...
  data: function() {
    return {
      elise: ["er svært komfortabel med å skryte av seg selv", "følte seg overhodet ikke dum da hun gjorde det", "er nå usikker på om hun har en personlighetsforstyrrelse"]
    }
  },
}
</script>
